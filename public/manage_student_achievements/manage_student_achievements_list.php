        ...
        <main class="bg-gray-50 flex flex-col flex-1 overflow-y-scroll h-screen flex-shrink-0 sc-hide pb-40">
            <div class="flex items-start justify-start p-6 shadow-md m-4 flex-1 flex-col">
                ...
                <div class="flex flex-row justify-between items-center w-full border-b-2 border-gray-600 mb-2 pb-2">
                    <h1 class="text-3xl text-gray-800 font-semibold w-full">Student Achievements</h1>
                    <div class="flex flex-row justify-end items-center">
                        <a href="<?php echo $baseUrl; ?>public/manage_student_achievements/manage_student_achievements_create.php" class="bg-green-500 hover-bg-green-700 text-white font-bold py-2 px-4 rounded inline-flex items-center">
                ...
                <div class="flex flex-col w-full">
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody>
                            <?php
                            // Fetch student achievement data from the database
                            $searchTerm = isset($_GET['search']) ? $_GET['search'] : '';
                            $page = isset($_GET['page']) ? $_GET['page'] : 1;

                            $query = "SELECT sa.*, u.FullName AS StudentName, ma.Points, ma.AchievementType, ma.AchievementName AS MasterAchievementName
                                ...
                                WHERE sa.AchievementName LIKE '%$searchTerm%'
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class='py-2'>
                                        ...
                                        <a href="<?php echo $baseUrl; ?>public/manage_student_achievements/manage_student_achievements_update.php?id=<?php echo $row['StudentAchievementID'] ?>" class='bg-blue-500 hover-bg-blue-700 text-white font-bold py-2 px-4 rounded inline-flex items-center text-sm'>
                                            <i class='fas fa-edit'></i>
                                        </a>
                                        <a href="#" onclick="confirmDelete(<?php echo $row['StudentAchievementID']; ?>)" class='bg-red-500 hover-bg-red-700 text-white font-bold py-2 px-4 rounded inline-flex items-center text-sm'>
    ...
    function confirmDelete(achievementID) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = `manage_student_achievements_delete.php?id=${achievementID}`;
            }
        });
    }
</script>
