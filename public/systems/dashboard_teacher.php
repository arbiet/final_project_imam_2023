...
$queryTotalStudents = "SELECT COUNT(*) AS TotalStudents FROM Students WHERE ClassID = $classID";
...
$queryMaleStudents = "SELECT COUNT(*) AS MaleStudents FROM Students
                     ...
                     WHERE Students.ClassID = $classID AND Users.Gender = 'Male'";
...
$queryFemaleStudents = "SELECT COUNT(*) AS FemaleStudents FROM Students
                       INNER JOIN Users ON Students.UserID = Users.UserID
                       WHERE Students.ClassID = $classID AND Users.Gender = 'Female'";
